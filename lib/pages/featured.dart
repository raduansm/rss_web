                  ...
                  TextButton(
                    ...
                    onPressed: () async {
                      if (ab.userType == 'tester') {
                        ...
                        reloadData();
                        Navigator.pop(context);
                        openDialog(context, 'Feature Item Removed Sucessfully!', 'This item has been removed from the featured list suceessfully.');
                      }
                    },
                  ),
                  SizedBox(width: 10),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      InkWell(
                        ...
                        onTap: () => navigateToCommentsPage(context, d.timestamp),
                      ),
                      SizedBox(
                        width: 10,
                      ),
